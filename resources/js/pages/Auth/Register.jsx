...
import { AlertCircle, Building2, CalendarDays, CheckCircle, Eye, EyeOff, Globe, MapPin, Phone } from "lucide-react"
import { useState } from "react"
import { Link, useNavigate } from "react-router-dom"
import { useAuth } from "../../contexts/AuthContext"
...
const Register = () => {
  ...
  // Sample countries and cities data - you can replace with an API or more comprehensive list
  const countries = [
    { code: "NP", name: "Nepal" },
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`appearance-none block w-full pl-10 px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
              ...
              {formData.country === "NP" && (
                <p className="mt-1 text-xs text-gray-500">Nepali format: +977 98XXXXXXXX</p>
              )}
            </div>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <select
                    ...
                    } ${!formData.country ? "bg-gray-50 cursor-not-allowed" : ""}`}
                  >
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
                    d="M10 0C4.477 0 0 4.484 0 10.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.269 2.75 1.026.8-.223 1.654-.334 2.504-.338.85.004 1.705.115 2.504.338 1.909-1.295 2.747-1.027 2.747-1.027.546 1.379.203 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0020 10.017C20 4.484 15.522 0 10 0z"
                    clipRule="evenodd"
                  />
                </svg>
                <span className="ml-2">GitHub</span>
