...
// //             type="submit"
// //             disabled={loading}
// //             className="w-full px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium disabled:opacity-50 flex items-center justify-center gap-2 mt-6"
// //           >
// //             {loading ? (
// //               <>
...
//     // If response has a data property (full axios response)
//     if (response && response.data !== undefined) {
//       successData = response.data
//     }
    
//     // Now check the success flag
//     if (successData && successData.success === true) {
//       setSuccess(successData.message || "Password changed successfully!")
//       // Clear form
//       setForm({
//         current_password: "",
//         new_password: "",
...
//       setShowConfirm(false)
//     } else {
//       setError(successData?.message || "Failed to change password")
//     }
//   } catch (err) {
//     setError(err.response?.data?.message || "An error occurred. Please try again.")
//   } finally {
